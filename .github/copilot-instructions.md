...
- Two-node cluster:
  - M1 (Execution Node): hosts Freqtrade instances, risk manager, live paper trading. Primary repo path: /Users/aatifquamre/Downloads/Aatif-qmr/cipher/ (absolute paths used widely).

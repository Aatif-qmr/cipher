"""
cipher_mcp/server.py
─────────────────────
Cipher MCP Server — exposes trading system state and controls to AI agents.

Usage:
    python -m cipher_mcp.server --port 9010
    python cipher_mcp/server.py --port 9010 --host 127.0.0.1
...
# Import FastMCP from PyPI mcp BEFORE adding project root to sys.path.
# The project root contains mcp/ which shadows the PyPI mcp package;
# keeping it off sys.path during this import ensures PyPI mcp is found first.
from mcp.server.fastmcp import FastMCP  # noqa: E402

# Now safe to add project root — cipher_mcp.tools.* are resolved from here.
sys.path.insert(0, str(_BASE))

from cipher_mcp.tools.hyperopt import control_hyperopt  # noqa: E402
from cipher_mcp.tools.sentiment import get_macro, get_sentiment, recall_vault  # noqa: E402
from cipher_mcp.tools.strategy import (  # noqa: E402
    get_risk_status,
    get_strategy_status,
    get_system_status,
)
from cipher_mcp.tools.trades import (  # noqa: E402
    get_open_trades,
    get_pnl_summary,

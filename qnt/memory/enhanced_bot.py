...
def send_notify(title: str, message: str, level: str = 'INFO', 
                use_imessage: bool = False) -> bool:
    """
...
def send_with_keyboard(title: str, message: str, keyboard_type: str, 
                       level: str = "INFO") -> Optional[int]:
...
def send_escalation(situation: str, options: List[str], recommendation: str, 
...
def execute_command_raw(command: str) -> str:
    ...
    try:
        ...
        return f"🖥️ <b>Command:</b> <code>{command}</code>\n━━━━━━━━━━━━━━━━━━━━━━\n<pre>{output}</pre>"

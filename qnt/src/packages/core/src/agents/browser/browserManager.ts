...
// Default browser profile directory name within ~/.qnt/
...
export class BrowserManager {
  ...
  private async connectMcp(): Promise<void> {
    ...
    // - "persistent": Persistent profile at ~/.qnt/cli-browser-profile/ (default)
    ...
    if (browserConfig.customConfig.profilePath) {
      ...
      // Default persistent profile lives under ~/.qnt/cli-browser-profile

...
export interface ReadManyFilesParams {
  ...
  /**
   * Whether to respect .gitignore and .qntignore patterns (optional, defaults to true)
   */
 ...
 * This combines the shared patterns with dynamic patterns like QNT.md.
...
${finalExclusionPatternsForDescription
  ...
  async execute({ abortSignal: signal }: ExecuteOptions): Promise<ToolResult> {
    ...
    // one, preventing shared parent QNT.md files from being injected twice.

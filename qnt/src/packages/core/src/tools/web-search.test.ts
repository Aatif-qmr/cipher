        ...
        candidates: [
          {
            ...
            groundingMetadata: {
              groundingChunks: [
                ...
                {
                  web: {
                    title: 'google-gemini/qnt',
                    uri: 'https://github.com/google-gemini/qnt',
                  },
                },
                {
                  web: {
                    title: 'qnt: your open-source AI agent',
                    uri: 'https://blog.google/technology/developers/introducing-qnt-open-source-ai-agent/',
                  },
                },
              ],
              groundingSupports: [
                ...
                {
                  segment: {
                    // Byte range of "qnt✨️" (utf-8 encoded)
                    startIndex: 17,
                    endIndex: 33,
                  },
...
[2] google-gemini/qnt (https://github.com/google-gemini/qnt)
[3] qnt: your open-source AI agent (https://blog.google/technology/developers/introducing-qnt-open-source-ai-agent/)`;

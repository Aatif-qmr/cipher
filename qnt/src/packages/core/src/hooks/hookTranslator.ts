...
/**
 * Decoupled LLM request format - stable across qnt versions
 */
...
/**
 * Decoupled LLM response format - stable across qnt versions
 */
...
/**
 * Decoupled tool configuration - stable across qnt versions
 */

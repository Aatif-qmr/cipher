...
export class Config implements McpContext, AgentLoopContext {
   ...
   * Whenever the user memory (QNT.md files) is updated.
   */
   ...
   * temporary directory, or is exactly the global personal `~/.qnt/QNT.md`
   * file (the latter is the only file under `~/.qnt/` that is reachable —
  ...
  isPathAllowed(absolutePath: string): boolean {
    ...
    // Surgical allowlist: the global personal QNT.md file (and ONLY that

  ...
  try {
    ...
    if (process.platform === 'darwin') {
      try {
        ...
        // Brew is not installed or qnt is not installed via brew.
    ...
    if (
      ...
      const updateCommand = 'pnpm add -g @google/qnt@latest';
      return {
    ...
    if (realPath.includes('/.yarn/global')) {
      const updateCommand = 'yarn global add @google/qnt@latest';
      return {
    ...
    if (realPath.includes('/.bun/install/global')) {
      const updateCommand = 'bun add -g @google/qnt@latest';
      return {
    ...
    // Assume global npm
    const updateCommand = 'npm install -g @google/qnt@latest';
    return {

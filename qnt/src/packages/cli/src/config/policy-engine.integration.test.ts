    ...
    describe.each(['write_file', 'replace'])(
      ...
      (toolName) => {
        it(`should allow ${toolName} to plans directory`, async () => {
          ...
          const validPaths = [
            '/home/user/.qnt/tmp/a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2/session-1/plans/my-plan.md',
            '/home/user/.qnt/tmp/a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2/session-1/plans/feature_auth.md',
            '/home/user/.qnt/tmp/new-temp_dir_123/session-1/plans/plan.md', // new style of temp directory
            'C:\\Users\\user\\.qnt\\tmp\\project-id\\session-id\\plans\\plan.md',
            'D:\\qnt\\.qnt\\tmp\\project-id\\session-1\\plans\\plan.md', // no session ID
          ];
        ...
        it(`should deny ${toolName} outside plans directory`, async () => {
          ...
          const invalidPaths = [
            ...
            '/home/user/.qnt/tmp/a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2/plans/script.js', // Wrong extension
            '/home/user/.qnt/tmp/a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2/plans/../../../etc/passwd.md', // Path traversal (Unix)
            'C:\\Users\\user\\.qnt\\tmp\\id\\session\\plans\\..\\..\\..\\Windows\\System32\\config\\SAM', // Path traversal (Windows)
            '/home/user/.qnt/non-tmp/new-temp_dir_123/plans/plan.md', // outside of temp dir
          ];

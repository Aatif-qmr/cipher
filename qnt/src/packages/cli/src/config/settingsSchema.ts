  ...
  ui: {
    ...
    properties: {
      ...
      showStatusInTitle: {
        ...
        default: false,
        description:
          'Show qnt model thoughts in the terminal window title during the working phase',
        showInDialog: true,
      },
      dynamicWindowTitle: {
        type: 'boolean',
      ...
      showHomeDirectoryWarning: {
        ...
        default: true,
        description:
          'Show a warning when running qnt in the home directory.',
        showInDialog: true,
      },
      ...
      hideContextSummary: {
        ...
        default: false,
        description:
          'Hide the context summary (QNT.md, MCP servers) above the input.',
        showInDialog: true,
      },
      footer: {
        type: 'object',
  ...
  context: {
    ...
    properties: {
      ...
      memoryBoundaryMarkers: {
        ...
        description:
          'File or directory names that mark the boundary for QNT.md discovery. ' +
      ...
      loadMemoryFromIncludeDirectories: {
        ...
        default: false,
        description: oneLine`
          Controls how /memory reload loads QNT.md files.
      ...
      fileFiltering: {
        ...
        properties: {
          ...
          respectGeminiIgnore: {
            type: 'boolean',
            label: 'Respect .qntignore',
            category: 'Context',
            requiresRestart: true,
            default: true,
            description: 'Respect .qntignore files when searching.',
            showInDialog: true,
          },
          enableFileWatcher: {
            type: 'boolean',
          ...
          customIgnoreFilePaths: {
            ...
            default: [] as string[],
            description:
              'Additional ignore file paths to respect. These files take precedence over .qntignore and .gitignore. Files earlier in the array take precedence over files later in the array, e.g. the first file takes precedence over the second one.',
            showInDialog: true,
            items: { type: 'string' },
            mergeStrategy: MergeStrategy.UNION,
          },
  ...
  experimental: {
    ...
    properties: {
      ...
      jitContext: {
        ...
        default: true,
        description:
          'Enable Just-In-Time (JIT) context loading. Defaults to true; set to false to opt out and load all QNT.md files into the system instruction up-front.',
        showInDialog: false,
      },
      useOSC52Paste: {
        type: 'boolean',
      ...
      gemmaModelRouter: {
        ...
        properties: {
          ...
          autoStartServer: {
            ...
            default: false,
            description:
              'Automatically start the LiteRT-LM server when qnt starts and the Gemma router is enabled.',
            showInDialog: true,
          },
          binaryPath: {
            type: 'string',
            ...
            default: '',
            description:
              'Custom path to the LiteRT-LM binary. Leave empty to use the default location (~/.qnt/bin/litert/).',
            showInDialog: false,
          },
          classifier: {
            type: 'object',
...
> = {
  MCPServerConfig: {
    ...
    properties: {
      ...
      extension: {
        type: 'object',
        description:
          'Metadata describing the qnt extension that owns this MCP server.',
  ...
  TelemetrySettings: {
    type: 'object',
    description: 'Telemetry configuration for qnt.',
    additionalProperties: false,
    properties: {
      enabled: {
        type: 'boolean',
  ...
  CustomTheme: {
    type: 'object',
    description:
      'Custom theme definition used for styling qnt output. Colors are provided as hex strings or named ANSI colors.',
    additionalProperties: false,
    properties: {
      type: {
        type: 'string',

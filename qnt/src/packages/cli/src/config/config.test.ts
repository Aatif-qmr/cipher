...
vi.mock('@google/gemini-cli-core', async () => {
  ...
  return {
    ...
    getAdminErrorMessage: vi.fn(
      (_feature) =>
        `YOLO mode is disabled by your administrator. To enable it, please request an update to the settings at: https://goo.gle/manage-qnt`,
    ),
    ...
    vi.spyOn(ExtensionManager.prototype, 'getExtensions').mockReturnValue([
      {
        ...
        id: 'ext1-id',
        version: '1.0.0',
        contextFiles: ['/path/to/ext1/QNT.md'],
        isActive: true,
      },
      {
        path: '/path/to/ext2',
  ...
  describe('extension plan settings', () => {
    beforeEach(() => {
      vi.spyOn(Storage.prototype, 'getProjectTempDir').mockReturnValue(
        '/mock/home/user/.qnt/tmp/test-project',
      );
    });

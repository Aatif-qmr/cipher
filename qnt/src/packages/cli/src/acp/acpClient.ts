  ...
  const mainOptions = [
    {
      ...
      description:
        'Let qnt decide the best model for the task: gemini-2.5-pro, gemini-2.5-flash',
    },
  ];
  ...
  if (shouldShowPreviewModels) {
    mainOptions.unshift({
      ...
      description: useGemini31
        ? 'Let qnt decide the best model for the task: gemini-3.1-pro, gemini-3-flash'
        : 'Let qnt decide the best model for the task: gemini-3-pro, gemini-3-flash',
    });
  }

...
const listSubCommand: SlashCommand = {
  name: 'list',
  description: 'List available qnt tools.',
...
const descSubCommand: SlashCommand = {
  ...
  description: 'List available qnt tools with descriptions.',
  kind: CommandKind.BUILT_IN,
  autoExecute: true,
  action: async (context: CommandContext): Promise<void> =>
...
export const toolsCommand: SlashCommand = {
  name: 'tools',
  description:
    'List available qnt tools. Use /tools desc to include descriptions.',
  kind: CommandKind.BUILT_IN,
  autoExecute: false,

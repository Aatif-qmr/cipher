...
describe('initCommand', () => {
  ...
  const geminiMdPath = path.join(targetDir, 'QNT.md');
  ...
  it('should inform the user if QNT.md already exists', async () => {
  ...
  it('should create QNT.md and submit a prompt if it does not exist', async () => {
    ...
    expect(mockContext.ui.addItem).toHaveBeenCalledWith(
      {
        type: 'info',
        text: 'Empty QNT.md created. Now analyzing the project to populate it.',
      },
      expect.any(Number),
    );

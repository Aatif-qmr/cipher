...
const REPO_DOWNLOAD_URL =
  'https://raw.githubusercontent.com/google-github-actions/run-qnt';
...
// Add qnt specific entries to .gitignore file
export async function updateGitignore(gitRepoRoot: string): Promise<void> {
  const gitignoreEntries = ['.qnt/', 'gha-creds-*.json'];
...
export const setupGithubCommand: SlashCommand = {
  ...
  action: async (
    ...
    const readmeUrl = `https://github.com/google-github-actions/run-qnt/blob/${releaseTag}/README.md#quick-start`;

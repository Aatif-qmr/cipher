...
export const INFORMATIVE_TIPS = [
  ...
  'Toggle respect for .qntignore files in context (/settings)…',
  ...
  'Show qnt status in the terminal window title (/settings)…',
  ...
  'Create a project-specific QNT.md file with /init',
  ...
  'Reload instructional context from QNT.md files with /memory reload',
  'List the paths of the QNT.md files in use with /memory list',

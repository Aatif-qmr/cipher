...
if (rootPackageJson.geminiSandboxImageUri) {
  rootPackageJson.geminiSandboxImageUri =
    rootPackageJson.geminiSandboxImageUri.replace(/:.*$/, `:${newVersion}`);
...
if (cliPackageJson.geminiSandboxImageUri) {
  cliPackageJson.geminiSandboxImageUri =
    cliPackageJson.geminiSandboxImageUri.replace(/:.*$/, `:${newVersion}`);
  console.log(
